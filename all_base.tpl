...
https://ocd0522.tk/ddgksf2013/Cuttlefish/raw/branch/master/Rewrite/AdBlock/StartUp.conf, tag=去广告规则, update-interval=86400, opt-parser=false, enabled=true
https://ocd0522.tk/ddgksf2013/Cuttlefish/raw/branch/master/Rewrite/AdBlock/WeiboLite.conf, tag=微博去广告, update-interval=86400, opt-parser=false, enabled=true
